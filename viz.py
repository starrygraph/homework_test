...
def visualize_comparisons(area_name, npy_folder, comparison_folder_list, limit=1, text=[], png_path="",
    ...
    gt_points, gt_colors = get_points_colors_from_obj(
        os.path.join(comparison_folder_list[0], '{}_gt.obj'.format(area_name)))
    idx = pc[:, 1] >= limit
